...
public class OpenWechatController {
    ...
    public ResponseEntity<String> getAppid() {
        return ResponseEntity.ok().body(wechatService.getWechatAppid());
    }

    @RequestMapping(value = "/api/open/wechat/access_token", method = RequestMethod.GET, produces = "text/plain; charset=UTF-8")
    public ResponseEntity<String> getAccessToken() {
        return ResponseEntity.ok().body(wechatService.getWechatAccessToken(false));
    }

    @RequestMapping(value = "/api/open/wechat/config", method = RequestMethod.GET, produces = "text/plain; charset=UTF-8")
    public ResponseEntity<String> getConfig(@RequestParam String url) {
        return ResponseEntity.ok().body(wechatService.getWechatConfig(url));
    }

    @RequestMapping(value = "/api/open/wechat/oauth", method = RequestMethod.GET, produces = "application/json; charset=UTF-8")
    public ResponseEntity<WechatUser> authWechatUserOAuth(@RequestParam String code) {
        WechatUser authenticatedUser = wechatService.authWechatUserOAuth(code);
        Boolean subscribed = false;

        if (authenticatedUser != null) {
            WechatUser wechatUserFromWechat = wechatService.getWechatUserInfo(authenticatedUser.getOpenid());
    ...
    @RequestMapping(value = "/api/open/wechat/jscode", method = RequestMethod.GET, produces = "application/json; charset=UTF-8")
    public ResponseEntity<WechatUser> authWechatUserJsCode(@RequestParam String code) {
        WechatUser authenticatedUser = wechatService.authWechatUserJsCode(code);
    ...
    @RequestMapping(value = "/api/open/wechat/message", method = RequestMethod.GET, produces = "text/plain; charset=UTF-8")
    public ResponseEntity<?> verifyMessageProcessor(
        ...
        params.add(nonce);
        params.add(wechatService.getWechatMessageToken());
    ...
    @RequestMapping(value = "/api/open/wechat/message", method = RequestMethod.POST, consumes = "text/xml; charset=UTF-8")
    ...
    public ResponseEntity<WechatUser> setWechatUser(@RequestBody WechatUser newWechatUser) throws URISyntaxException {
    ...
    public ResponseEntity<String> getAvatar(@RequestParam String openid) {
        WechatUser wechatUser = wechatUserService.getWechatUser(openid);
        if (wechatUser != null) {
            // not authorized
    ...
    public ResponseEntity<Integer> getGender(@RequestParam String openid) {
        WechatUser wechatUser = wechatUserService.getWechatUser(openid);
        if (wechatUser != null) {
            // not authorized
            if (wechatUser.getScope().equals("snsapi_base")) {
    ...
    public ResponseEntity<String> getNickname(@RequestParam String openid) {
        WechatUser wechatUser = wechatUserService.getWechatUser(openid);
        if (wechatUser != null) {
            // not authorized
            if (wechatUser.getScope().equals("snsapi_base")) {
    ...
    public ResponseEntity<String> getUnionid(@RequestParam String openid) {
        WechatUser wechatUser = wechatUserService.getWechatUser(openid);
        if (wechatUser != null) {
            // not authorized
            if (wechatUser.getScope().equals("snsapi_base")) {
